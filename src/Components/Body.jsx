  ...
  return (
    <div className="space-y-4 lg:flex">
        ...
        <div className='lg:flex-1 lg:order-1'>
            ...
            <p className="font-lato text-gray-400 "> With Hosterr, get youe website up and running in no less than 5 miutes with most competitive pricing packages</p>
        ...
        <div className="flex gap-2">
            <img src="./assets/Checkmark.svg" alt="check"className=""/>
